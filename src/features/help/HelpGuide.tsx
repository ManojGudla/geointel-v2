          ...
          <div className="help-guide__content">
            ...
            {section === "agents" && (
              <>
                ...
                <p>Open <strong>🤖 Ask</strong> in the workspace rail for the AI Agents. There are six focused agents, each reading the same real on-screen data from its own angle:</p>
                <ul>
