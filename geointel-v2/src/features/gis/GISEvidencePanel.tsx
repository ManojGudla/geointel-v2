  ...
  return (
    <div className="gis-evidence-panel">
      ...
      <AsyncPanel
        ...
        isEmpty={(e) => e.counts.buildings + e.counts.shops + e.counts.offices + e.counts.amenities === 0}
            ...
            {showWhy && (
              <div className="gis-evidence-panel__why">
                <p>
                  ...
                  offices weight toward commercial, residential buildings and landuse toward residential, and schools/hospitals/civic
                  buildings toward institutional.
                </p>
                <p>
